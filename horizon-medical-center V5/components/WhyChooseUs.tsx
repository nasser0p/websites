        ...
        <div className="mt-16 grid gap-8 md:grid-cols-3">
          {whyChooseUs.map((item, index) => {
            ...
            return (
              <div 
                key={item.id} 
                className={`text-center p-8 bg-white rounded-lg shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 ease-out hover:shadow-brand-teal/20 tappable ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}
