    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-xl overflow-hidden group">
            ...
            >
                ...
                <img src={item.beforeImageUrl} alt="Before treatment" className="absolute inset-0 w-full h-full object-cover" draggable="false" />
                ...
                <div className="absolute inset-0 w-full h-full" style={clipperStyle}>
                    <img src={item.afterImageUrl} alt="After treatment" className="absolute inset-0 w-full h-full object-cover" draggable="false" />
                </div>
                ...
                <div className="absolute top-0 bottom-0 bg-white w-1 pointer-events-none -translate-x-1/2" style={handleContainerStyle}>
                    <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 bg-white h-10 w-10 rounded-full shadow-lg flex items-center justify-center border-2 border-brand-teal animate-subtle-pulse">
                        <svg className="w-6 h-6 text-brand-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"></path></svg>
                    </div>
                </div>
