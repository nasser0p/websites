  ...
  return (
    <section id="about" className="py-20 md:py-28 bg-white" ref={ref}>
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className={`mt-16 max-w-4xl mx-auto bg-gray-50 p-10 rounded-lg shadow-xl text-center transition-all duration-700 ease-in-out ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-5 scale-95'}`} style={{ transitionDelay: '200ms' }}>
