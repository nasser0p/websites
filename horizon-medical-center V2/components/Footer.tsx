// FIX: Create Footer component to resolve module import error.
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left rtl:md:text-right">
                    ...
                    <div>
                        ...
                        <address className="not-italic space-y-2 text-gray-400">
                           <p>{text.address}</p>
                           <p><a href={`tel:${text.phone?.replace(/\s/g, '') || ''}`} className="hover:text-brand-teal transition-colors" dir="ltr">{text.phone}</a></p>
