...
function App() {
  ...
  const [whatsAppModalData, setWhatsAppModalData] = useState<{ message: string; url: string } | null>(null);
  ...
  const openWhatsAppModal = (message: string, url: string) => {
    setWhatsAppModalData({ message, url });
  };
  ...
  return (
    <LanguageContext.Provider value={languageContextValue}>
      ...
      <WhatsAppModal 
        ...
        whatsappUrl={whatsAppModalData?.url || ''}
      />
