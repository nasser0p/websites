...
const Footer: React.FC = () => {
    ...
    const dentistSchema = {
      ...
      "url": "https://hoorizonmedical.com", // Replace with actual domain
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left rtl:md:text-right">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link to="/" className="hover:text-brand-teal transition-colors">{text.navHome}</Link></li>
                            <li><Link to="/services" className="hover:text-brand-teal transition-colors">{text.navServices}</Link></li>
                            <li><Link to="/about" className="hover:text-brand-teal transition-colors">{text.navAbout}</Link></li>
                            <li><Link to="/contact" className="hover:text-brand-teal transition-colors">{text.navContact}</Link></li>
                        </ul>
                    </div>
